        ...
        <div class="wrapper">
            ...
            <form action="{{ route('buytoken') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="category">
                    <div class="category-basic">
                        <label for="basic-1" class="basic1token">
                            <div class="imgName">
                                <span class="name">Basic 1 <br> 1 Token <br> 30 Minutes <br> IDR 75.000</span>
                            </div>
                        ...
                        <label for="basic-2" class="basic2token">
                            <div class="imgName">
                                <span class="name">Basic 2 <br> 2 Token <br> 60 Minutes <br> IDR 150.000</span>
                            </div>
                            <span class="check"><i class="fa-solid fa-circle-check" style="color: #6064b6;"></i></span>
                        </label>
                        ...
                        <label for="basic-3" class="basic3token">
                            <div class="imgName">
                                <span class="name">Basic 3 <br> 6 Token <br> 180 Minutes <br> IDR 450.000</span>
                            </div>
                            <span class="check"><i class="fa-solid fa-circle-check" style="color: #6064b6;"></i></span>
                        </label>
                    </div>
                    <div class="category-flexi">
                        <label for="flexi-1" class="flexi1token">
                            <div class="imgName">
                                <span class="name">Flexi 1 <br> 4 Token <br> 2 Hours <br> IDR 280.00</span>
                            </div>
                            <span class="check"><i class="fa-solid fa-circle-check" style="color: #6064b6;"></i></span>
                        </label>
                        ...
                        <label for="flexi-2" class="flexi2token">
                            <div class="imgName">
                                <span class="name">Flexi 2 <br> 20 Token <br> 10 Hours <br> IDR 1.200.000</span>
                            </div>
                            <span class="check"><i class="fa-solid fa-circle-check" style="color: #6064b6;"></i></span>
                        </label>
                        ...
                        <label for="flexi-3" class="flexi3token">
                            <div class="imgName">
                                <span class="name">Flexi 3 <br> 40 Token <br> 20 Hours <br> IDR 2.000.000</span>
                            </div>
                            <span class="check"><i class="fa-solid fa-circle-check" style="color: #6064b6;"></i></span>
                        </label>
                        ...
                        <label for="flexi-4" class="flexi4token">
                            <div class="imgName">
                                <span class="name">Flexi 4 <br> 100 Token <br> 50 hours <br> IDR 4.000.000</span>
                            </div>
                            <span class="check"><i class="fa-solid fa-circle-check" style="color: #6064b6;"></i></span>
                        </label>
                    </div>
                ...
                <div class="input_group">
                    <div class="input_box">
                        <input type="text" placeholder="Full Name" required class="name" value="{{ $user->name }}" disabled>
                        <i class="fa fa-user icon"></i>
                    </div>
                </div>
                <div class="input_group">
                    <div class="input_box">
                        <input type="email" placeholder="Email Address" required class="name" value="{{ $user->email }}" disabled>
                ...
                <div class="input_group">
                    <div class="input_box">
                        <input type="text" placeholder="Address" required class="name" value="{{ $user->address }}" disabled>
