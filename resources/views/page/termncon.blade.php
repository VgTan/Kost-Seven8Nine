...
<head>
    ...
    <link rel="stylesheet" href="/css/termncon.css">
        ...
        <div class="tc_main">
            <div class="tc_content">
                <div class="tc_top">
                    ...
                    <div class="info">
                        Welcome to Rhapsodie.co Music Space!
                        <br><br>
                        These terms and conditions outline the rules and regulations for the use of Rhapsodie.co Music
                        Space's Website. By accessing this website we assume you accept these terms and conditions. Do
                        not continue to
                        use Rhapsodie.co Music Space if you do not agree to take all of the terms and conditions stated
                        on this page.
                    </div>
                </div>
                <div class="tc_bottom">
                    ...
                    <div class="info">
                        <h3>Cookies</h3>
                        <p>We employ the use of cookies. By accessing Rhapsodie.co Music Space, you agreed to use
                            cookies in agreement with the Rhapsodie.co Music Space's Privacy Policy.</p>
                        <p>Most interactive websites use cookies to let us retrieve the user's details for each visit.
                            ...
                            use cookies.</p>
                        <h3>License</h3>
                        <p>Unless otherwise stated, Rhapsodie.co Music Space and/or its licensors own the intellectual
                            property rights for all material on Rhapsodie.co Music Space. All intellectual property
                            rights are reserved. You may access this from Rhapsodie.co Music Space for your own personal
                        ...
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                            information in certain areas of the website. Rhapsodie.co Music Space does not filter, edit,
                            publish or review Comments prior to their presence on the website. Comments do not reflect
                            the views and opinions of Rhapsodie.co Music Space,its agents and/or affiliates. Comments
                            reflect the views and opinions of the person who post their views and opinions. To the
                            extent permitted by applicable laws, Rhapsodie.co Music Space shall not be liable for the
                        ...
                        <p>Rhapsodie.co Music Space reserves the right to monitor all Comments and to remove any
                        ...
                        <br>
                        <p>You hereby grant Rhapsodie.co Music Space a non-exclusive license to use, reproduce, edit and
                        ...
                        <p>We will approve link requests from these organizations if we decide that: (a) the link would
                            ...
                            visibility of the hyperlink compensates the absence of Rhapsodie.co Music Space; and (d) the
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking
                            to our website, you must inform us by sending an e-mail to Rhapsodie.co Music Space. Please
                        ...
                        <br>
                        <p>No use of Rhapsodie.co Music Space's logo or other artwork will be allowed for linking absent
