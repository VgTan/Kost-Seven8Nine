...
<body>
    ...
    <div class="policy-container">
        <div class="policy-main">
            <h1>Privacy Policy for Rhapsodie.co Music Space</h1>

            <p>At Rhapsodie.co Music Space, accessible from ., one of our main priorities is the privacy of our
                visitors.
                This
                Privacy Policy document contains types of information that is collected and recorded by Rhapsodie.co
                Music
                Space
                and how we use it.</p>
            ...
            <p>Rhapsodie.co Music Space follows a standard procedure of using log files. These files log visitors when
                they
            ...
            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Rhapsodie.co
                Music
                Space.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in
                their respective advertisements and links that appear on Rhapsodie.co Music Space, which are sent
                directly
                to
            ...
            <p>Note that Rhapsodie.co Music Space has no access to or control over these cookies that are used by
                third-party
                advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>Rhapsodie.co Music Space's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                advising
            ...
            <p>Rhapsodie.co Music Space does not knowingly collect any Personal Identifiable Information from children
                under
                the
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards
                to the information that they shared and/or collect in Rhapsodie.co Music Space. This policy is not
                applicable to
