   ...
   <section class="contact-form">
    ...
    <div class="contactForm">
        ...
        <div class="map-container">
            <div class="mapBg"></div>
            <div class="map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.0570242063795!2d106.61598747461866!3d-6.256218461252195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69fb56b25975f9%3A0x50c7d605ba8542f5!2sMultimedia%20Nusantara%20University!5e0!3m2!1sen!2sid!4v1699385362399!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>            </div>
        </div>
    </div>
    ...
    <div class="contactMethod">
        <div class="method">
            ...
            <article class="text">
                ...
                <p class="para">Cluster Allogio, Gading Serpong, Tangerang, Indonesia</p>
            </article>
        </div>
        ...
        <div class="method">
            ...
            <article class="text">
                ...
                <p class="para">biuro@hotelsalut.pl</p>
            </article>
        </div>
        ...
        <div class="method">
            ...
            <article class="text">
                ...
                <p class="para">+32 324 434 432 421</p>
            </article>
        </div>
    </div>
   </section>
